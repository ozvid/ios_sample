...
//  AJProgressView
//
//  Created by Shiv Charan Panjeta < shiv@ozvid.com > on 22/09/17.
...
class AJProgressView: UIView {
    ...
    private var widthProgressView : CGFloat {
        ...
        if DeviceType.iPhone4 || DeviceType.iPhone5_5s{
            width = ScreenSize.Min_Length*0.20
    ...
    public var imgLogo: UIImage = UIImage(named:"ic_logo_login")!
...
//        }
        ...
        visibleController.view.addSubview(objProgressView)
        visibleController.view.bringSubviewToFront(objProgressView)
        ...
        let xConstraint = NSLayoutConstraint(item: objProgressView, attribute: .centerX, relatedBy: .equal, toItem: visibleController.view /*appDelegate.window!*/, attribute: .centerX, multiplier: 1, constant: 0)
        
        let yConstraint = NSLayoutConstraint(item: objProgressView, attribute: .centerY, relatedBy: .equal, toItem: visibleController.view /*appDelegate.window!*/, attribute: .centerY, multiplier: 1, constant: 0)
        
        /*appDelegate.window?*/visibleController.view.addConstraint(xConstraint)
        /*appDelegate.window?*/visibleController.view.addConstraint(yConstraint)
